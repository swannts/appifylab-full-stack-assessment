...
export default function TimelinePost({ authorName, postTitle, imageSrc }: TimelinePostProps) {
  return (
    <div className="_feed_inner_timeline_post_area _b_radious6 _padd_b24 _padd_t24 _mar_b16">
      <div className="_feed_inner_timeline_content _padd_r24 _padd_l24">
        ...
        <h4 className="_feed_inner_timeline_post_title">{postTitle}</h4>
        <div className="_feed_inner_timeline_image">
          <img src={imageSrc} alt="" className="_time_img" />
        </div>
      </div>
      ...
      <div className="_timline_comment_main">
        <div className="_previous_comment">
          <button type="button" className="static _previous_comment_txt" style={{ backgroundColor: 'transparent', border: 0, padding: 0 }}>View 4 previous comments</button>
        </div>
