...
export default function CreatePostCard({ user, onPostCreated }: CreatePostCardProps) {
  ...
  const handleCreatePost = async (e: React.FormEvent) => {
    ...
    const validationResult = postSchema.safeParse({
      ...
      imageUrl: selectedFile ? 'file_uploaded' : undefined,
      visibility,
    });

    if (!validationResult.success) {
      setFormError(validationResult.error.issues.map((issue) => issue.message).join(' '));
      return;
    }
  ...
  return (
    <div className="_feed_inner_text_area _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
      {formError && (
        <div className="alert alert-danger" role="alert" style={{ borderRadius: '12px', fontSize: '13px', marginBottom: '16px' }}>
          {formError}
        </div>
      )}
      ...
      <form onSubmit={handleCreatePost}>
        ...
        {previewUrl && (
          <div className="my-3 position-relative" style={{ borderRadius: '8px', overflow: 'hidden' }}>
            <img src={previewUrl} alt="Preview" style={{ width: '100%', maxHeight: '220px', objectFit: 'cover' }} />
            <button
              type="button"
        ...
        <div className="_feed_inner_text_area_bottom">
          <div className="_feed_inner_text_area_item">
            <div className="_feed_inner_text_area_bottom_photo _feed_common">
              <input
                ...
                className="d-none"
              />
              <label htmlFor="feed-file-picker" className="_feed_inner_text_area_bottom_photo_link">
          ...
          <div className="_feed_inner_text_area_btn">
            <button type="submit" disabled={submitting} className="_feed_inner_text_area_btn_link">
